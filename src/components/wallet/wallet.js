...
const Cards = ({ name, amount, dateTime, trans_id }) => (
  <View style={globalStyles.cardContainer}>
    <View style={globalStyles.row}>
      ...
      <Text style={[styles.amountText, { color: colors.green200, fontSize: fonts.sizes.semismall }]}>
        + ₹ {amount}
      </Text>
    </View>
    <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
      <Text style={[styles.dateText, { fontSize: fonts.sizes.semismall, fontFamily: fonts.families.secondary }]}>
